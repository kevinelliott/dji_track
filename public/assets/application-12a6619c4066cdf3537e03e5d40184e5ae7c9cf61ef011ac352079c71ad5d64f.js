...
(function() {
  $(document).on('ready turbolinks:load', function() {
    return $('body').on('click', '[data-toggle="modal"]', function() {
      $($(this).data('target') + ' .modal-body').load($(this).data("remote"));
      return $($(this).data('target') + ' .modal-title').html('Change History for ' + $(this).data('maskedOrderId'));
    });
  });
